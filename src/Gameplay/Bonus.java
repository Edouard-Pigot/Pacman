...
public class Bonus extends ImageView implements StaticEntity, ScoreEntity {
    ...
    private void setFruit(int level){
        if(level<=1) {
            value = 100;
            image = new Image("file:Images/CHERRY.png");
        }
        else if(level <= 2) {
            value = 300;
            image = new Image("file:Images/STRAWBERRY.png");
        }
        else if(level <=4) {
            value = 500;
            image = new Image("file:Images/PEACH.png");
        }
        else if(level <=6) {
            value = 700;
            image = new Image("file:Images/APPLE.png");
        }
        else if(level <=8) {
            value = 1000;
            image = new Image("file:Images/MELON.png");
        }
        else if(level <=10) {
            value = 2000;
            image = new Image("file:Images/GALAXIAN.png");
        }
        else if(level <=12) {
            value = 3000;
            image = new Image("file:Images/BELL.png");
        }
        else {
            value = 5000;
